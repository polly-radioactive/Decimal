# Decimal
В этом проекте я работала над реализацией библиотеки s21_decimal.h на языке программирования C. Эта библиотека добавляет поддержку типа данных "decimal", который отсутствует в стандарте языка. Однако этот тип является критически важным для задач, связанных с финансовыми расчетами, где ошибки вычислений, присущие типам с плавающей точкой, неприемлемы. В рамках этого проекта я ознакомилась с задачами обработки финансовых данных, изучила тонкости внутреннего представления различных типов данных и закрепила структурированный подход.
